...
void mine(){
	...
	case 5:
		...
		break;
	case 6:
		system("sudo git clone https://github.com/cybereagle2001/passgen.git");
		break;
	case 00:
		exitc();
		break;
...
void help(char user){
	...
	printf(" * rm -R : usage(rm -R <directory name>): remove a full directory \n");
	printf(" * rmdir : usage(rmdir <directory name>): remove an empty file \n");
	...
	printf(" * pwd : usage (pwd) : print working directory\n");
	printf(" * wc : usgae (wc <filename>) : count the number of words lines and caracters\n");
	printf(" * top : top is a task manager program, found in many Unix-like operating systems, that displays information about CPU and memory utilization\n");
	printf("\n");
